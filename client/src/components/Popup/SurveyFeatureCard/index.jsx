...
function SurveyFeatureCard({
	open, domainId, featureId, handleCloseClick, surveyProductId,
}) {
	...
	return (
		...
		>
			...
			>
				...
				>
					<FeatureCardContent featureId={featureId} surveyProductId={surveyProductId} />
				</CardContent>
			</Card>
		</Dialog>
	);
